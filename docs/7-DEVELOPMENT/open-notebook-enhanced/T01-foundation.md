...
- [共通契約](contracts.md) — 状態遷移、責務分担、モード意味、データ/API契約、エラー形式の一次参照先。T02〜T11 はこの文書の各節を実装する。
- [ADR-009](../decisions/ADR-009-enhanced-state-persistence.md) — 永続化・マイグレーション・後方互換性の方針。
